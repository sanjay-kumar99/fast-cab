...
exports.createBooking = (req, res) => {
  ...
  const sql = "INSERT INTO bookings (name, phone, pickup, drop_location, ride_datetime, status, created_at) VALUES (?, ?, ?, ?, ?, 'Pending', NOW())";

  db.query(sql, [name, phone, pickup, drop_location, ride_datetime], (err, result) => {
    if (err) {
